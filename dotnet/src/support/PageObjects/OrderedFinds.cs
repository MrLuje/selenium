// <copyright file="OrderedFindsAttribute.cs" company="WebDriver Committers">
...
{
    /// <summary>
    /// Marks elements to indicate that each <see cref="OrderedFindsAttribute"/> on the field or
    ...
    /// <para>
    /// <code>
    /// // Will find the element with the ID attribute matching "elementId" and if not found will find
    /// // an element with the ID attribute matching "childElementId".
    /// [OrderedFinds]
    ...
    public sealed class OrderedFindsAttribute : Attribute
    {
